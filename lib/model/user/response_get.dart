...
ModelResponseUser modelResponseUserFromJson(String str) => ModelResponseUser.fromJson(json.decode(str));
...
class ModelResponseUser {
  ...
  factory ModelResponseUser.fromJson(Map<String, dynamic> json) => ModelResponseUser(
